...
function App() {
  ...
  return (
    ...
    <span className="   text-transparent bg-clip-text bg-gradient-to-br from-pink-400 to-red-600"><TypeAnimation className=" text-center pl-6  text-transparent bg-clip-text bg-gradient-to-br from-purple-900 to-pink-500 "
      sequence={[
